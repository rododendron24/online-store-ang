...
export class FavoriteService {
  ...
  getFavorites(): Observable<FavoritesType[]> {
    return this.http.get<FavoritesType[]>(environment.api + 'favorites');
  }

  addToFavorites(productId: string): Observable<FavoritesType[] | DefaultResponseType> {
    return this.http.post<FavoritesType[] | DefaultResponseType>(
  ...
  removeFromFavorites(productId: string): Observable<DefaultResponseType> {
    return this.http.delete<DefaultResponseType>(
      environment.api + 'favorites/' + productId
    );
  }
}
